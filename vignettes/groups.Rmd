...
These 3 groups coincide with our previously identified SNP groups for C, D, and A, as given in snpGroups.

#check
```{r,eval=FALSE}
setdiff(snpGroups[["C"]],sgroups$groups@.Data[[1]])
setdiff(snpGroups[["D"]],sgroups$groups@.Data[[2]])
setdiff(snpGroups[["A"]],sgroups$groups@.Data[[3]])
```
