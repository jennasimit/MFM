...
1.  [Introduction](#org72673d2)
2.  [MFM Overview](#orgb256e08)
3.  [Simulation Example](#org1a577b0)
...
group C. The file null<sub>100k.controls.gen</sub> is output from the above hapgen code and needed below.  An example file is provided with
