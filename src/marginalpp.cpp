...
List calcQ3(const List S1,
  ...
  for(int i1=0; i1<nmod1; i1++) {
     for(int i2=0; i2<nmod2; i2++) {
       int idx1=stroverlap(S1[i1], S2[i2]);
...
List calcQ4(const List S1,
  ...
  for(int i1=0; i1<nmod1; i1++) {
	 ...
	 for(int i4=0; i4<nmod4; i4++) {
	   ...
	   if(idx > 0) {
	     idx = idx - 1;
	     Q1(i1,idx) = Q1(i1,idx) + pp2(i2) * pp3(i3) * pp4(i4);
	     Q2(i2,idx) = Q2(i2,idx) + pp1(i1) * pp3(i3) * pp4(i4);
	     Q3(i3,idx) = Q3(i3,idx) + pp1(i1) * pp2(i2) * pp4(i4);
	     Q4(i4,idx) = Q4(i4,idx) + pp1(i1) * pp2(i2) * pp3(i3);
	   }
	 }
       }
     }
